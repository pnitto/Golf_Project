...
def scatter_to_base64(data, user):
    ...
    plt.title('Score Totals per Scorecard', weight="bold", fontsize="18")
...
def scatter_to_base641(data,user):
    ...
    plt.title('Green In Regulation Totals(%) per Par Type', fontsize="18", weight="bold")
...
def scatter_to_base642(data_1,user):
    ...
    plt.xlabel('Par Type', weight="bold", fontsize="18")
    plt.title('Fairway in Regulation Totals(%) per Par Type', fontsize="18", weight="bold")
